			...
			<div
				...
				<div class="bg-body d-flex flex-column align-items-stretch flex-center rounded-4 w-md-600px p-20">
					...
					<div class="d-flex flex-center flex-column flex-column-fluid px-lg-10 pb-15 pb-lg-20">
						<!--begin::Form-->
						<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="{{ route('sign-in') }}" method="POST">
						@csrf
							<!--begin::Heading-->
							...
							<div class="d-flex flex-stack flex-wrap gap-3 fs-base fw-semibold mb-8">
								<div></div>
								<!--begin::Link-->
								<a href="/lupa-pw" class="link-primary">Forgot Password ?</a>
								<!--end::Link-->
							</div>
							<!--end::Wrapper-->
							<!--begin::Submit button-->
							...
							<div class="text-gray-500 text-center fw-semibold fs-6">Not a Member yet?
								<a href="/sign-up" class="link-primary">Sign up</a>
							</div>
							<!--end::Sign up-->
						</form>
						<!--end::Form-->
					...
					<div class="d-flex flex-stack px-lg-10">
						...
						<div class="d-flex fw-semibold text-primary fs-base gap-5">
							<a href="../../demo31/dist/pages/team.html" target="_blank">Terms</a>
							<a href="../../demo31/dist/pages/pricing/column.html" target="_blank">Plans</a>
							<a href="../../demo31/dist/pages/contact.html" target="_blank">Contact Us</a>
						</div>
						<!--end::Links-->
					</div>
					<!--end::Footer-->
